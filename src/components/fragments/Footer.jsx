...
import ImageWithMarquee from '../elements/AlternatingMarquee/AlternatingMarquee'
  ...
  return (
    <footer className="bg-white">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        ...
        {/* <HeartText /> */}
        {/* <img src="/img/love.png" alt="" className='w-96' />
        <AlternatingMarquee /> */}
        <ImageWithMarquee />
        {/* <div
          className="pt-8 mt-16 border-t border-gray-100 sm:flex sm:items-center sm:justify-between "
        >
